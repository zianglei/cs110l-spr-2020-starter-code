...
fn main() {
    ...
    let seq1 = read_file_lines(filename1).unwrap_or_else(|_| panic!("Invalid filename1: {}", filename1));
    let seq2 = read_file_lines(filename2).unwrap_or_else(|_| panic!("Invalid filename2: {}", filename2));
